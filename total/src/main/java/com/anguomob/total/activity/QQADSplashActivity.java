...
public class QQADSplashActivity extends AppCompatActivity implements SplashADListener, View.OnClickListener {
    ...
    String postID = "";
    private Class<Activity> mainActivity = null;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.anguo_activity_splash);
        postID = getIntent().getExtras().getString("postId");
        mainActivity = (Class<Activity>) getIntent().getSerializableExtra("mainActivity");
    ...
    private void next() {
        if (canJump) {
            if (needStartDemoList) {
                this.startActivity(new Intent(this, mainActivity));
            }
            this.finish();
        } else {
            canJump = true;
    ...
    public void onNoAD(AdError adError) {
        final String str = String.format("LoadSplashADFail, eCode=%d, errorMsg=%s", adError.getErrorCode(),
                adError.getErrorMsg());
        Log.i("AD_DEMO", str);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (needStartDemoList) {
                    QQADSplashActivity.this.startActivity(new Intent(QQADSplashActivity.this, mainActivity));
                }
                QQADSplashActivity.this.finish();
            }
        }, shouldDelayMills);
    }
